...
//================================================
//Предложенные аргументы внутри колбеэка (ФИЛЬТЕР)
...
// 1)
console.log(array.filter((value, index) => console.log(value, index)));
// 2)
console.log(array.filter((value, index) => index % 2 === 0)); // можно вывести четные или не четный индекс
// 3)
console.log(array.filter((value, index, arr) => console.log(value, index, arr))); 