...
const clik = document.createElement('button');
clik.innerText = 'Сделать квадрат желтым';

clik.onclick = ()=>{
 div.style.background = 'yellow';
}
document.body.append(div, clik);
...
//               }
        //// второй варинат
p.textContent = p.textContent === cards[i].en ? cards[i].ru : cards[i].en
         }
 }
