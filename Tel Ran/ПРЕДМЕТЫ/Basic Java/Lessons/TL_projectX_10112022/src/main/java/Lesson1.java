...
public class Lesson1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(welcomeUser(test));
    }

    static String welcomeUser(@NotNull String name) {

        String temp_str = "Welcome, " + name.toUpperCase();
        return temp_str;

    }

    static void getSolutionForLeftRotatedArray() {
        ...
        int shift = 2; // restrict to max length of shift

        int[] resultArr = new int[originalArr.length];
//        long start = System.nanoTime();
        for (int i = shift; i < originalArr.length; i++) {
            resultArr[i - shift] = originalArr[i];
        }
        System.out.println(Arrays.toString(resultArr));


//        int[] resultArr = Arrays.copyOfRange(originalArr, shift, originalArr.length + shift);

        for (int i = 0; i < shift; i++) {
            resultArr[i + originalArr.length - shift] = originalArr[i];
        }
...
//            for (int i = 0; i < shift; i++) {
//
//                int firstElement = originalArr[0];
//
//                for (int j = 0; j < originalArr.length - 1; j++)
//                    originalArr[j] = originalArr[j + 1];
//
//                int lastIndex = originalArr.length - 1;
//                originalArr[lastIndex] = firstElement;
//            }
////            System.out.println(Arrays.toString(originalArr));
//        } else {
//            System.out.println("shift must be positive");
//        }
...
//        System.out.println((finish - start));
    ...
    static void getSecondSolution() {
        ...
        Scanner scanner = new Scanner(System.in);
        System.out.println("Enter pls input line: ");
        String input_str = scanner.nextLine();
        if (input_str.length() > 0)
            System.out.println("Words number is: " + input_str.split(" ").length);
        else
            System.out.println("Enter pls a line");
...
//                }
//            }
//            System.out.println("Words number is: " + (spaces + 1));
//        }
...
//        }
    ...
    static void getLastExample() {
        /*
        Дан массив (N-1), в котором не хватает одного элемента, содержащий только
        различные целые числа в диапазоне от 1 до N . Найдите недостающий элемент.
         */

        int[] input = {1,7,4,2,5,6};
        ...
        System.out.println("Target value: " + sum);

        int sumCurrentArr = 0;
        for (int i = 0; i < input.length; i++) {
            sumCurrentArr += input[i];
        }

        System.out.println("Current value: " + sumCurrentArr);


    }

    static void getTask01112022() {
        /*
        ...
        int[] preoutputArr = new int[lengthOfArr];

        int curentValue = 1;
        for (int i = lengthOfArr - 1; i >= 0; i--, curentValue += 2) {
            preoutputArr[i] = curentValue;
        }

        System.out.println(Arrays.toString(preoutputArr));
    }

    static void getExamplesOfRandom() {
        ...
        System.out.println("int#2: " + r.nextInt(10));
        System.out.println("float: " + f);
        System.out.println("double: " + d);
        System.out.println("boolean: " + b);


        System.out.println("randomByMath: " + (int)(Math.random() * 100));
    }

    static void getPersons() {
        Person[] people = new Person[4];
        people[0] = new Person("Bob Morley");
        people[1] = new Person("Lady Gaga");
        people[2] = new Person("Justin Biber");
        people[3] = new Person("Justin Timberlake");
