...
//        остается менее 5 этажей, то лифт сможет проехать нужный ему промежуток.
        ...
        int finishPosition1= 163;
        int itern1  = 4;
        do {
            itern1 = finishPosition1 / itern1;
            startPosition1++;
        } while (startPosition1 < finishPosition1);

        System.out.println(itern1);
        }



       static void sumViaForLoop2() {
    /*
